...
import com.research.usage_stats.util.BitmapUtil;
...
public class DetailActivity extends AppCompatActivity {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            if (item.mEventType == UsageEvents.Event.ACTIVITY_PAUSED) {
            ...
            } else if (item.mEventType == UsageEvents.Event.ACTIVITY_RESUMED) {
                holder.mLayout.setPadding(dpToPx(16), dpToPx(12), dpToPx(16), 0);
            }
            holder.mEvent.setText(String.format("%s %s", getPrefix(item.mEventType), desc)); // timeline
        }
