package com.research.usage_stats.data;
...
public class DataManager {
    ...
    public List<AppItem> getApps(Context context, int sort, int offset) {
        ...
        if (manager != null) {
            ...
            long[] range = AppUtil.getTimeRange(SortEnum.getSortEnum(offset));
//            String st=AppUtil.formatMilliSeconds(range[0]);
//            String ei= AppUtil.formatMilliSeconds(range[1]);
//            List<UsageStats> usageStats= manager.queryUsageStats(0,range[0],range[1]);
//            String totalTime="";
//            long Time=0;
//            for(UsageStats e: usageStats){
//                if(e.getTotalTimeInForeground()>0)
//                    Time+=e.getTotalTimeInForeground();
//
//            }
//            totalTime+=AppUtil.formatMilliSeconds(Time);
